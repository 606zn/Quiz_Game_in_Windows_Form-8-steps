        ...
        private void checkAnswerEvent(object sender, EventArgs e)
        {
            ...
            if(questionNumber == totalQuestions)
            {
                ...
                MessageBox.Show(
                    ...
                    "You have answered " + score + "questions correstly." + Environment.NewLine +
        ...
        private void askQuestion(int qnum)
        {
            switch(qnum)
            {
                ...
                case 4:
                    ...
                    lblQuestion.Text = "What Publisher made this game?";
                ...
                case 8:
                    ...
                    lblQuestion.Text = "Which city is the capital city of England?";

                    button1.Text = "Birmingham";
                    button2.Text = "Brightoon";
